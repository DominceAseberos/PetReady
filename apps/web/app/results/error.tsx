  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4" role="alert">
      <div className="text-center">
        <h2 className="font-display text-xl font-bold text-gray-900">Results unavailable</h2>
        <p className="mt-2 text-sm text-gray-600">{error.message || 'Failed to load your results.'}</p>
